      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-6 lg:p-8 max-w-3xl mx-auto">
          <div className="mb-8 flex items-center justify-between gap-4 animate-fade-up stagger-1">
            ...
            <HelpButton tutorial={dashboardTutorials.mathsHelper} />
          </div>
          <div className="rounded-2xl p-6 mb-6 bg-white dark:bg-dark-900 border border-slate-200 dark:border-dark-700 animate-fade-up stagger-2">
            ...
            <div className="mb-5" data-tutorial="problem-input">
              <label className="block text-sm font-semibold mb-2 text-slate-800 dark:text-slate-200">
          ...
          {result && (
            <div className="space-y-4 animate-fade-in" data-tutorial="solution">
